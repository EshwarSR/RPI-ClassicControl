...
class Actor(nn.Module):
	def __init__(self, state_dim, action_dim, max_action, arch=[256, 256]):
...
class Critic(nn.Module):
	def __init__(self, state_dim, action_dim, arch=[256, 256]):
		...
		# Q1 architecture
		self.l1 = nn.Linear(state_dim + action_dim, arch[0])
		self.l2 = nn.Linear(arch[0], arch[1])
		self.l3 = nn.Linear(arch[1], 1)

		# Q2 architecture
		self.l4 = nn.Linear(state_dim + action_dim, arch[0])
		self.l5 = nn.Linear(arch[0], arch[1])
		self.l6 = nn.Linear(arch[1], 1)
