...
OUTPUT_FILENAME = 'env_change_performance_comparison_all_algorithms-FINAL-FINAL.png'
OUTPUT_FILENAME_PDF = 'env_change_performance_comparison_all_algorithms_SMALL.pdf'
...
def generate_table_data():
    ...
    csv_filename = 'env_change_results_summary_all_algorithms.csv'
    df.to_csv(csv_filename, index=False)
    print(f"\nTable saved to {csv_filename}")

    latex_filename = 'env_change_results_summary_all_algorithms.tex'
